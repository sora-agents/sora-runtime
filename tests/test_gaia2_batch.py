...
from examples.gaia2._runner import _make_stop_when
...
def _agent_with(states: list[ActivityState]) -> SimpleNamespace:
    activities = {i: SimpleNamespace(state=s) for i, s in enumerate(states)}
